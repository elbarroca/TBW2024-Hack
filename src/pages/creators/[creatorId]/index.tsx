  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <h1 className="text-3xl font-bold text-gray-900">{CREATOR_DATA.name}</h1>
              ...
              <div className="mt-4 flex flex-wrap justify-center md:justify-start gap-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="ml-1">{CREATOR_DATA.students.toLocaleString()} students</span>
                </div>
                <div className="flex items-center">
        ...
        {/* Creator's Courses */}
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Courses by {CREATOR_DATA.name}</h2>
