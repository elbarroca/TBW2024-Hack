...
const fileUploadSchema = z.object({
  ...
  fileType: z.enum(['template', 'guide', 'resource', 'document', 'other'] as const)
...
export default function CreateFile() {
  ...
  const { register, handleSubmit, watch, formState: { errors } } = useForm<FileUploadFormData>({
              ...
              <div className="border rounded-lg p-6 bg-gray-50">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p>{FILE_TYPES.find(type => type.value === watch('fileType'))?.label || 'Not selected'}</p>
                  </div>
                  <div>
