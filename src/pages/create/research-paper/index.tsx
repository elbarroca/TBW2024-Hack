...
const researchPaperSchema = z.object({
  ...
  authors: z.string()
    .min(3, 'Authors field is required'),
...
export default function CreateResearchPaper() {
  ...
  const { register, handleSubmit, watch, formState: { errors } } = useForm<ResearchPaperFormData>({
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Upload a Research Paper</h1>
          <p className="text-gray-600">
            Share your academic or technical research with the community. Add metadata, set a price, and upload your document.
          </p>
        </div>
