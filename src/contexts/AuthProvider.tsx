...
import { resetUserData, setBalances, setTransactions, setUserDataError, setUserDataLoading } from '@/store/user'
import { setLoginStatus, LoginStatus, setUser, setAddress, setAuthLoading, setAuthError } from '@/store/auth'
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const handleChallenge = useCallback(async (address: string) => {
