      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <p className="mt-2 text-3xl font-bold text-gray-900">{DASHBOARD_STATS.totalStudents}</p>
            <div className="mt-2 text-sm text-green-600">↑ 12% from last month</div>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <h3 className="text-gray-500 text-sm font-medium">Total Earnings</h3>
            <p className="mt-2 text-3xl font-bold text-gray-900">{DASHBOARD_STATS.totalEarnings} SOL</p>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <p className="mt-2 text-3xl font-bold text-gray-900">{DASHBOARD_STATS.averageRating}</p>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <p className="mt-2 text-3xl font-bold text-gray-900">{DASHBOARD_STATS.completionRate}%</p>
